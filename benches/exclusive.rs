...
use criterion::{black_box, Criterion, BenchmarkId, criterion_main, criterion_group};
use pprof::criterion::{Output, PProfProfiler};
use talaria::channel::Channel;
use crate::common::{bench_scenarios, BenchArgs};

fn run_exclusive_benchmark<M>(channel: &Channel<M>, partition_id: usize, chunk: usize, amount: usize) {
    ...
    c.bench_with_input(
        ...
        |b, args | {
            b.iter_custom(|iterations| {
                let BenchArgs { channel_size, chunk_size } = *args;
