...
pub enum TalariaError {
    #[error(
        "too few partitions requested on partitioned ring. requested: {requested}. required: 2"
    )]
    ...
    RequestedZeroElements { partition_id: usize },
